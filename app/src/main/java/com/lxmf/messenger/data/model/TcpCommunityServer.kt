...
object TcpCommunityServers {
    val servers: List<TcpCommunityServer> = listOf(
        TcpCommunityServer("acehoss", "rns.acehoss.net", 4242),
        ...
        TcpCommunityServer("mobilefabrik TCP", "phantom.mobilefabrik.com", 4242),
        ...
        TcpCommunityServer("ON6ZQ", "reticulum.on6zq.be", 4965),
        ...
        TcpCommunityServer("rtclm.de", "rtclm.de", 4242),
        TcpCommunityServer("SparkN0de", "aspark.uber.space", 44860),
        TcpCommunityServer("Sydney RNS", "sydney.reticulum.au", 4242),
